...
import { getUsuarios, getAsesores, getAreasActivas, getCargosActivos } from "@/lib/admin/queries";
...
export default async function UsuariosPage() {
  ...
  const [usuarios, asesores, areas, cargos] = await Promise.all([
    getUsuarios(),
    getAsesores(),
    getAreasActivas(),
    getCargosActivos(),
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <UsuariosView usuarios={usuarios} areas={areas} cargos={cargos} puedeEditar={puedeEditar} />
